...
<div id="works" style="padding-top: {worksParentHeight * .1}px; margin-top: -{worksParentHeight * .09}px;" class="relative flex justify-center z-10 w-full bg-gradient-to-b from-black/0 via-10% via-black to-black">
