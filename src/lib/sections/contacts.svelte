    ...
    <div class="relative grid grid-cols-2 gap-12 w-full max-w-sm md:max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-2 md:mx-4 lg:mx-5 xl:mx-8 py-52">
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex justify-between items-center mt-4">
                ...
                <button  bind:this={submit_button} type="button" class="bg-gradient-to-r from-pink/80 to-orange/80 hover:from-pink/90 hover:to-orange/90 px-10 py-2 rounded-sm flex gap-1 items-center border border-white font-medium">
                    Send
